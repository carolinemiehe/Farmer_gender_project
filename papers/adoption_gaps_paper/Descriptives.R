...
#shall I delete the category 'other'?
...
baseline_farmers$Check2.check.maize.q14 <- as.numeric(as.character(baseline_farmers$Check2.check.maize.q14))
baseline_farmers$Check2.check.maize.q14[baseline_farmers$Check2.check.maize.q14 == 999] <- NA
baseline_farmers$Check2.check.maize.q14[baseline_farmers$Check2.check.maize.q14 < 15 |baseline_farmers$Check2.check.maize.q14 > 99] <- NA
...
# Quante osservazioni valide per yield e area?
sum(!is.na(baseline_farmers$Check2.check.maize.q50))
sum(!is.na(baseline_farmers$Check2.check.maize.q51))
sum(!is.na(baseline_farmers$yield_inkg))

# Percentuale di dati mancanti per genere
table(is.na(baseline_farmers$yield_inkg), baseline_farmers$hh_gender_num)

# Quante righe sono perse nella divisione per area
sum(!is.na(baseline_farmers$r_maize_plot_area))
sum(!is.na(baseline_farmers$yield_per_acre))
...
baseline_farmers$maize_income <- baseline_farmers$bags_sold * baseline_farmers$bag_price
baseline_farmers$maize_income[baseline_farmers$maize_income <= 0] <- NA
...
variables <- c(
  ...
  "maize_sold", #The household sold maize (1 = Yes)
